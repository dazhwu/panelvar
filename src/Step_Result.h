...
class Step_Result {
public:
    RowMatrixXd residual, _residual_t, XZ_W, W, W_inv, W_next, _M_XZ_W, zs, qs,ZuuZ,  M,
            _zs_list, beta, vcov, std_err;



	Step_Result(RowMatrixXd &W_, RowMatrixXd &W_inv_, RowMatrixXd &W_next_, RowMatrixXd &XZ_W_,
