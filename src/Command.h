...
class Command {
  public:
    ...
    void parse_spaced_vars(std::vector<std::string> list_vars, List_Variables &dest_list);
...
std::tuple<vector<string>, struct model_options> process_command(int, string, int, string, string, string,
                                                                 vector<string> &);
