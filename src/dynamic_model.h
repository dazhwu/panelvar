...
vector<returned_result> prepare_data(vector<string> &, Ref<RowMatrixXd>, vector<int> &, vector<string> &,
                                     vector<string> &, int, int);

void update_time_dummies(vector<string> &col_timedumm, struct df_info &info, model &m);
...
struct basic_info generate_model_info(int N, int T, Ref<RowMatrixXd> z_table, VectorXi &na_records,
                                      struct z_info &z_information, model &m, vector<string> &);
...
template <class ty> RowMatrixXd gen_table(Ref<RowMatrixXd> ori_data, vector<ty> variable_list, vector<string> df_cols);
...
std::tuple<RowMatrixXd, RowMatrixXd> get_final_xy_systemGMM(Ref<RowMatrixXd> Dx, Ref<RowMatrixXd> Dy,
                                                            Ref<RowMatrixXd> x, Ref<RowMatrixXd> y, vector<int> cut,
                                                            vector<int> Dcut, int cut_height, int Dcut_height,
                                                            string transformation);

std::tuple<RowMatrixXd, RowMatrixXd> get_final_xy_diffGMM(Ref<RowMatrixXd> Dy, Ref<RowMatrixXd> Dx, vector<int> Dcut,
                                                          int Dcut_height);
